...
public class StudentController {
    ...
    @PostMapping
    public ResponseEntity<?> createStudentHandler(@Valid @RequestBody Students student) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateStudentHandler(@PathVariable("id") Long id, @RequestBody Students student) {
        try {
    ...
    public ResponseEntity<?> enrollStudentToSubjectHandler(@PathVariable("studentId") Long studentId, @PathVariable("subjectId") Long subjectId) {
        try {
    ...
    public ResponseEntity<?> registerStudentForExamHandler(@PathVariable("studentId") Long studentId, @PathVariable("examId") Long examId) {
        try {
